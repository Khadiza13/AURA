...
public class adminpanel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(adminpanel.this);// context name as per your project name
    ...
    public void UploadImage() {
        ...
        if (FilePathUri != null) {
            ...
            Toast.makeText(adminpanel.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
